...
SRC= $(SPECSRC) 404.dd cpptod.dd ctod.dd pretod.dd cppcontracts.dd index.dd overview.dd	\
	...
	changelog\2.072.2.dd changelog\2.073.0_pre.dd changelog\index.dd \
...
changelog\2.070.0.html : $(CHANGELOG_DDOC) changelog\2.070.0.dd
	$(DMD) -o- -c -D -Df$*.html $(CHANGELOG_DDOC) $*.dd
changelog\2.070.1.html : $(CHANGELOG_DDOC) changelog\2.070.1.dd
	$(DMD) -o- -c -D -Df$*.html $(CHANGELOG_DDOC) $*.dd
changelog\2.070.2.html : $(CHANGELOG_DDOC) changelog\2.070.2.dd
	$(DMD) -o- -c -D -Df$*.html $(CHANGELOG_DDOC) $*.dd
changelog\2.071.0.html : $(CHANGELOG_DDOC) changelog\2.071.0.dd
	$(DMD) -o- -c -D -Df$*.html $(CHANGELOG_DDOC) $*.dd
changelog\2.071.1.html : $(CHANGELOG_DDOC) changelog\2.071.1.dd
	$(DMD) -o- -c -D -Df$*.html $(CHANGELOG_DDOC) $*.dd
changelog\2.071.2.html : $(CHANGELOG_DDOC) changelog\2.071.2.dd
	$(DMD) -o- -c -D -Df$*.html $(CHANGELOG_DDOC) $*.dd
...
changelog\2.072.2.html : $(CHANGELOG_DDOC) changelog\2.072.2.dd
	$(DMD) -o- -c -D -Df$*.html $(CHANGELOG_DDOC) $*.dd
changelog\2.073.0.html : $(CHANGELOG_PRE_DDOC) changelog\2.073.0_pre.dd
