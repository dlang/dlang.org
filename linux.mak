...
all : html phobos-prerelease druntime-prerelease #phobos-release druntime-release
...
${DOC_OUTPUT_DIR}/phobos/object.html : ${DMD_DIR}.${LATEST}/src/dmd
	...
	make --directory=${DRUNTIME_DIR}.${LATEST} -f posix.mak -j 4 \
...
${DOC_OUTPUT_DIR}/phobos/index.html : \
	...
	make --directory=${PHOBOS_DIR}.${LATEST} -f posix.mak clean
	make --directory=${PHOBOS_DIR}.${LATEST} -f posix.mak -j 4 \
	  DMD=${DMD_DIR}.${LATEST}/src/dmd
	make --directory=${PHOBOS_DIR}.${LATEST} -j 4 -f posix.mak html \
	  DMD=${DMD_DIR}.${LATEST}/src/dmd \
